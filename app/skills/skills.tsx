...
export default function Skills() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen text-white py-16 md:py-20 lg:py-24 px-6 md:px-12 lg:px-16 overflow-hidden"
    >
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1920&q=80&auto=format&fit=crop')`,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-white leading-tight max-w-4xl">
              ...
              <span className="text-white/50">every product</span> or service
              has an easy to use experience on all platforms, and my mission is
              to make it happen.
            </h2>
          </motion.div>
