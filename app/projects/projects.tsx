      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12 mb-16 md:mb-20 lg:mb-24">
          ...
          >
            ...
            memorable web experiences, products and design in life.
          </motion.h2>
        </div>
        ...
        <div className="space-y-0 relative">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="group relative border-b border-white/20 py-6 md:py-8 cursor-pointer"
            >
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 items-center transition-all duration-300">
                {/* Project Name */}
                <motion.div
                  whileHover={{ x: 10 }}
              ...
              {hoveredProject === project.name && (
                ...
                >
                  <div className="relative w-[400px] h-[300px] rounded-2xl overflow-hidden shadow-2xl border-2 border-[#c8ff00]/50">
                    <Image
                      src={project.image}
                      alt={project.name}
                      fill
