...
export default function Hero() {
  return (
    <section className="relative w-screen min-h-screen bg-[#1a1a1a] overflow-hidden flex items-center justify-center px-6 md:px-16 lg:px-20 pt-24 pb-16 xl:pt-40 xl:pb-40">
      {/* Section Number */}
      <motion.div
      ...
      {/* Main Content */}
      <div className="max-w-7xl w-full mt-16 md:mt-24 lg:mt-28 xl:mt-32 mb-16">
        {/* Large Headline */}
