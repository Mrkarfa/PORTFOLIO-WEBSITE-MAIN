...
export default function Contact() {
    ...
    const services = ["Website Design", "Development", "Brand Design", "Mobile Design"];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                        ...
                        <div className="flex flex-wrap gap-2">
                            {platforms.map((platform) => (
                                <motion.button
                                    ...
                                    className={`px-6 py-2 rounded-full border text-base md:text-lg transition-colors ${formData.platform === platform
                        ...
                        <div className="flex flex-wrap gap-2">
                            {services.map((service) => (
                                <motion.button
                                    ...
                                    className={`px-6 py-2 rounded-full border text-base md:text-lg transition-colors ${formData.services.includes(service)
                                            ? "bg-white text-black border-white"
                                            : "border-white/30 hover:border-white"
                                        }`}
                                >
                        ...
                        <div className="flex flex-wrap gap-2">
                            {budgets.map((budget) => (
                                <motion.button
                                    ...
                                    className={`px-6 py-2 rounded-full border text-base md:text-lg transition-colors ${formData.budget === budget
                                            ? "bg-white text-black border-white"
                                            : "border-white/30 hover:border-white"
                                        }`}
                                >
                    ...
                    <div className="flex flex-wrap items-baseline gap-3 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light">
                        ...
                        />
                        <span>to begin the conversation. I would like to share more about my project :</span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pt-8">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            transition={{ type: "spring", stiffness: 200, damping: 15 }}
                            className="px-8 md:px-12 py-4 md:py-5 bg-[#c8ff00] text-black font-medium text-base md:text-lg rounded-full flex items-center gap-3 hover:bg-[#b3e600] transition-colors"
                        >
                            Start A Journey
